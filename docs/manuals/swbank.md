# パフォーマンスバンク(SwPatch)マップ

音色本体とは独立して、ベロシティ感度・ビブラート・デチューンなど
の演奏表現を切り替えるための補助バンクです。多くの音色パッチには
あらかじめ標準的な組み合わせが紐づけられているため、通常は
意識する必要はありません。

[← 目次に戻る](README.md)

## sw_bank = 0: Performance SwPatch Presets
...
| 14 | Detune Mid |
| 15 | Detune Strong |
| 16 | Combo VelVibDetune Off |
| 17 | Combo VelVibDetune Weak |
| 18 | Combo VelVibDetune Mid |
| 19 | Combo VelVibDetune Strong |
| 20 | Combo VelDrumLFO Off |
